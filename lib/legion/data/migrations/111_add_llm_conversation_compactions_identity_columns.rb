...
Sequel.migration do
  up do
    ...
    run 'CREATE INDEX IF NOT EXISTS idx_conversation_compactions_access_scope ON llm_conversation_compactions (access_scope)'
    run <<~SQL
      CREATE INDEX IF NOT EXISTS idx_conversation_compactions_identity_principal_id
  ...
  down do
    run 'DROP INDEX IF EXISTS idx_conversation_compactions_access_scope'
    run 'DROP INDEX IF EXISTS idx_conversation_compactions_identity_principal_id'
