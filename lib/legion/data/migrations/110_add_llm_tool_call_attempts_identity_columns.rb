...
Sequel.migration do
  up do
    ...
    run 'CREATE INDEX IF NOT EXISTS idx_tool_call_attempts_access_scope ON llm_tool_call_attempts (access_scope)'
    run <<~SQL
      CREATE INDEX IF NOT EXISTS idx_tool_call_attempts_identity_principal_id
  ...
  down do
    run 'DROP INDEX IF EXISTS idx_tool_call_attempts_access_scope'
    run 'DROP INDEX IF EXISTS idx_tool_call_attempts_identity_principal_id'
